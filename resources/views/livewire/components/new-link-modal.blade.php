        ...
        <form wire:submit="store">
            ...
            <div class="modal-action">
                <button wire:click="$dispatch('close.modal')"
                    class="btn btn-neutral border-1 border-slate-500/70 bg-slate-950 font-semibold text-slate-100 shadow-2xl shadow-purple-950/50 rounded-full px-4">
                    Cancelar
                </button>
                <button type="submit"
                    class="btn btn-neutral bg-purple-600 hover:bg-purple-600 font-semibold text-slate-100 shadow-2xl shadow-purple-950/50 border-none rounded-full px-4">
                    Criar link
                </button>
            </div>
        </form>
